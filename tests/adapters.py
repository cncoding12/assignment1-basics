...
def run_linear(
    ...
    from cs336_basics.model import Linear  # 请根据实际文件路径调整 import

    # 实例化 Linear 模块
    linear = Linear(in_features, out_features, device=x.device, dtype=x.dtype)
...
def run_multihead_self_attention(
    ...
    # 载入测试权重 (注意：我们的 Linear 类权重存放在 self.W 中)
